...
console.log(`Sk-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+60109173294'; // Replace this with the actual owner number
        const ownerName = 'Sk Official'; // Replace this with the owner's name
        const organization = 'Sk CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+60109173294', '') + '+60109173294@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_Sk-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> Sk-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ Sk-MD REPO: ${bot.bot.REPO_LINK
